...
#AVAHI 368
iptables -A INPUT -p tcp --dport 368 -j ACCEPT
iptables -A OUTPUT -p tcp --sport 368 -j ACCEPT


# ALPES 462

iptables -A INPUT -p tcp --dport 462 -j ACCEPT
iptables -A OUTPUT -p tcp --sport 462 -j ACCEPT

# TCPNETHASPSRV 475	

iptables -A INPUT -p tcp --dport 475 -j ACCEPT
iptables -A OUTPUT -p tcp --sport 475 -j ACCEPT
